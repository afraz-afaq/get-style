...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $users = [
            ...
            [
                'id'           => 9,
                'full_name'    => 'Metha Akram',
                'email'        => "mka@getstyle.com",
                'password'     => bcrypt('123456'),
                'phone'        => "+92348229941",
                'account_type' => Constant::ROLES['STYLIST'],
                'created_at'   => Carbon::now(),
            ...
            [
                'id'           => 10,
                'full_name'    => 'Harshad Arshad',
                'email'        => "ha@getstyle.com",
                'password'     => bcrypt('123456'),
                'phone'        => "+923182243633",
                'account_type' => Constant::ROLES['STYLIST'],
                'created_at'   => Carbon::now(),
            ...
            [
                'id'           => 11,
                'full_name'    => 'Karan Kareem',
                'email'        => "kkk@getstyle.com",
                'password'     => bcrypt('123456'),
                'phone'        => "+92333288544",
                'account_type' => Constant::ROLES['STYLIST'],
                'created_at'   => Carbon::now(),
            ...
            [
                'id'           => 12,
                'full_name'    => 'Suleman John',
                'email'        => "sj@getstyle.com",
                'password'     => bcrypt('123456'),
                'phone'        => "+923482212456",
                'account_type' => Constant::ROLES['STYLIST'],
                'created_at'   => Carbon::now(),
